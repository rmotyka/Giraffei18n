...
let indexHandler (name : string) =
    let hello = getLocalString "Hello"
    let greetings = sprintf "%s %s" hello name
...
let webApp =
    choose [
        GET >=>
            choose [
                route "/" >=> warbler (fun _ -> indexHandler "world")
